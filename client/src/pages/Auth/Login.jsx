...
const Login = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Login | AI Expense Manager</title>
                <meta name="description" content="Sign in to your AI Expense Manager account to manage your expenses, track budgets, and get personalized financial insights." />
                <meta name="keywords" content="login, sign in, expense manager, AI finance" />
                <meta property="og:title" content="Login | AI Expense Manager" />
                <meta property="og:description" content="Sign in to your AI Expense Manager account to manage your expenses, track budgets, and get personalized financial insights." />
